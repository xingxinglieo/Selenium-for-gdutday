...
import { router as getSchoolOpening } from "~/app/apis/school/getSchoolOpening";
const routerList = [getNetInfo, getPayImg, loginQuTuo, text, login,update,getSchoolOpening];
